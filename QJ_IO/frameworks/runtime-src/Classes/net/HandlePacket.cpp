...
//#endif
        ...
        case jynetwork::proto::eSCUserDetailInfo:
        {
            ...
            cocos2d::Director::getInstance()->getScheduler()->performFunctionInCocosThread([=]{
                ...
                cocos2d::EventCustom event("onLogin");
            ...
            if (pmsg->result() == ::jynetwork::proto::eOpertionResult::eOper_net_battle_add_player) {
                if (pmsg->friend_detail_size() >0) {
                    ...
                    for (int i=0; i< pmsg->friend_detail_size(); i++) {
                        ...
                        DataDoc::getInstance()->add_rivalInfo(friend_detail);
                    }
                    cocos2d::Director::getInstance()->getScheduler()->performFunctionInCocosThread([=]{
                        auto dispatcher = cocos2d::Director::getInstance()->getEventDispatcher();
                ...
                //进入战斗界面
                int seed = pmsg->rand_num();
                BulletManager::getInstance()->setSeed(seed);
                cocos2d::Director::getInstance()->getScheduler()->performFunctionInCocosThread([]{
        ...
        case jynetwork::proto::eSCMessageBattleReward:
        {
            //战斗结束
            
            cocos2d::Director::getInstance()->getScheduler()->performFunctionInCocosThread([=]{
                auto dispatcher = cocos2d::Director::getInstance()->getEventDispatcher();
                cocos2d::EventCustom event("GameOver");
                dispatcher->dispatchEvent(&event);
                cocos2d::EventCustom event2("showBtn");
        ...
        case jynetwork::proto::eSCMessageNetBattleOper:
        {
            ...
            DataDoc::getInstance()->add_battle_player_data(pmsg);
            ...
            for (int i=0; i<pmsg->opers_size(); i++) {
                ...
                switch (oper->oper()) {
                    ...
                    {
                        DataDoc::getInstance()->setPlayerScore(oper->player_id(),oper->now_score());
                    }
                        break;
                    case ::jynetwork::proto::eNetBattleOper::eBattle_next_wave :
                    {
                   
                            cocos2d::Director::getInstance()->getScheduler()->performFunctionInCocosThread([=]{
                                auto dispatcher = cocos2d::Director::getInstance()->getEventDispatcher();
                                cocos2d::EventCustom event("AllPlayersReady");
                                dispatcher->dispatchEvent(&event);
